    ...
    return(
        <>
          <div className='ab-main-container'>
            <div className='rg-button-back-container'>
                <Link to="/">
            ...
            <form className='rg-form' onSubmit={handleSubmit}>
                ...
                <div className='lg-container-buttons-form'>
                  ...
                  <div className='lg-container-input-password'>
                    <input 
                      className='rg-input-button-password'
                      name='password'
                      autoComplete='off' 
                      ...
                      required/>
                    <span className='rg-show-password-button' onClick={() => setShowPassword(!showPassword)}>
                      {showPassword ?
                  ...
                  <br />
                  <input className="rg-input-submit-button" type="submit" value="Register" />
                </div>
            </form>
          </div>     
        </>
